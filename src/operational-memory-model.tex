...
\begin{itemize}
\item \nameref{omm:early_sc_fail}: This causes the {\tt sc} to fail early, either a spontaneous fail or because it is not paired with a program-order-previous {\tt lr}.
\item \nameref{omm:paired_sc}: This is an alternative to \nameref{omm:early_sc_fail}, indicating the {\tt sc} is paired with an {\tt lr} and might succeed.
...
\item for fence, {\it kind} identifies whether it is a normal or TSO, and (for normal fences) the predecessor and successor sets;
