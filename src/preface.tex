...
\item Defined the signed-zero behavior of FMIN.{\em fmt} and FMAX.{\em fmt},
  ...
  specification.
\item The memory consistency model has been defined
\item The ``Zam'' extension permits misaligned AMOs and specifies their semantics.
\item The ``Ztso'' extension enforces a stricter default memory consistency model
