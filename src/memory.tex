...
ARM load-exclusive and store-exclusive instructions can likewise map onto their RISC-V LR and SC equivalents; but, instead of placing a FENCE~RW,RW in front of {\tt lr.\{w|d\}.aq} we add {\tt .rl} to it.
